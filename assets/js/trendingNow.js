document.write(`
  <div class="row text-category" style="margin-bottom: 68px">
    <span class="text-white display-3">New Releases</span>
  </div>
 <div id="carouselCardsControls" class="carousel">
  <div class="carousel-inner carousel-inner-category">
    <div class="carousel-item item-category active">
      <div class="card-wrapper">
        <div class="card rounded-5 border-0" style="width: 300px">
          <img
            src="https://holaa.codexshaper.com/wp/wp-content/uploads/2024/03/trending-3.png"
            alt
            class="card-img rounded-4 border-0"
          />
          <!-- transition background -->
          <div
            class="card-hover card-img-overlay d-block rounded-5"
          ></div>
          <!-- play button -->
          <div
          ...
          >
            ...
            >
              <div class="row">
                <h4
                  class="movie-title card-title text-uppercase fw-bold h4"
                >
                  Enigma of Shadows
                </h4>
              </div>
              <div class="row">
                <ul
                  class="d-flex gap-2 align-items-center justify-items-center"
                >
    ...
    <div class="carousel-item item-category">
      <div class="card-wrapper">
        <div class="card rounded-5 border-0" style="width: 300px">
          <img
            src="https://holaa.codexshaper.com/wp/wp-content/uploads/2024/03/trending-3.png"
...
<button class="carousel-control-prev" type="button" data-bs-target="#carouselCardsControls" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
</button>
<button class="carousel-control-next" type="button" data-bs-target="#carouselCardsControls" data-bs-slide="next">
